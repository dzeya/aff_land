...
import { Scroll, Smartphone, Zap, Music, Brain } from 'lucide-react';
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-serif text-stone-900 mb-4">
              If your affirmations fade by lunchtime, <br />
              <span className="italic text-terracotta-600">it’s not your fault.</span>
            </h2>
            <p className="text-lg text-stone-600 max-w-2xl mx-auto">
              Classic apps send you beautiful lines like “I am worthy”. You feel better for a moment—until stress comes back. The problem isn’t the affirmation. It’s how your brain stores it.
            </p>
          </div>
      ...
      <section className="py-24 px-6 bg-white relative">
        ...
        <div className="container mx-auto max-w-6xl grid md:grid-cols-2 gap-16 items-center">
             ...
             <div className="absolute bottom-10 left-10 right-10 z-20 bg-white/90 backdrop-blur p-6 rounded-2xl shadow-lg">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold text-stone-800">Encoding "I am secure"...</p>
                  </div>
                </div>
             </div>
          </div>
          ...
          <div className="order-1 md:order-2">
            <span className="text-terracotta-600 font-bold tracking-widest text-xs uppercase mb-4 block">The Solution</span>
            <h2 className="text-4xl md:text-5xl font-serif text-stone-900 mb-6 leading-tight">
              Meet Affirmetry: <br/>
              The <span className="text-lilac-600 italic">musical</span> affirmation app.
            </h2>
            <p className="text-lg text-stone-600 mb-8">
              Affirmetry takes the affirmations you already believe in—self-love, confidence, abundance—and delivers them through specially composed songs engineered to become earworms. 
            </p>

            <ul className="space-y-6">
              {[
                { title: "Classic Content, New Format", desc: "“I am” statements about love, money, body—now as catchy tracks." },
                { title: "The Earworm Effect", desc: "Designed so phrases resurface in your mind while you shower or walk." },
                { title: "Science-backed, not “woo-woo”", desc: "Built on neuroplasticity and Involuntary Musical Imagery (INMI)." },
                { title: "Effortless Practice", desc: "No journaling, no long meditations. Just press play." }
              ].map((item, idx) => (
            ...
            <div className="mt-10">
              <p className="text-xl font-serif italic text-stone-400 mb-6">"Don’t just read affirmations. Install them."</p>
            </div>
          </div>
        </div>
      </section>
